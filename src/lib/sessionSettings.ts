...
// Per-show report settings (fuzzy threshold, auto-advance/autoplay severity — spec §12), kept
// in-memory only rather than persisted to IndexedDB: they're a "how strict should this check be"
// dial for the current session, not part of the Show's durable record.
